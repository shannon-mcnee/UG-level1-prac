...
Luckily, R can make this task a lot less painful through the use of **join verbs** and **set operations**. 
...
Well done! You now have an understanding of **data relations** and the various ways R can help you to combine data from various different sources to help keep your analysis path clean and tidy. 
